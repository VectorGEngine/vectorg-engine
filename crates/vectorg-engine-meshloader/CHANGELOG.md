...
Renamed the crate from `vectorg_engine-stl` to `vectorg_engine-meshloader`, to better reflect its support for multiple formats.
...
This is the initial release of the `vectorg_engine-stl` crate.
